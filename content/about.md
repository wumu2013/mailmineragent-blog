---
title: "About MailMiner Agent Blog"
url: "/about/"
description: "About the MailMiner Editorial Team — cross-border e-commerce operators, TikTok Shop sellers, and AI tooling builders publishing real case studies, not generic theory."
layout: "single"
---
...
A typical reader is a technical founder or a solo operator who wants to ship AI tooling **and** turn it into a real business — or who is simply curious how the other half thinks. If that sounds like you, start with the [Posts](/posts/) page or jump into one of our most-cited case studies below.

## Who We Are

The MailMiner Editorial Team is a group of cross-border e-commerce operators, TikTok Shop sellers, and AI tooling builders. We are the same team behind [mailminer.work](https://mailminer.work), a commercial AI email-mining and automation product. The blog is an editorial side-project: it is not a marketing channel for the product, and we keep the two clearly separated.
...
1. **Real sources, not inventions.** Every case study comes from a named seller interview, a public report, or our own product experiments. We do not invent revenue figures, seller identities, or product details to make a point land harder.
2. **Figures are reported, not audited.** When we cite revenue, order counts, or margin ranges, we are reporting what the seller told us. We disclose this in every post. Margin assumptions are stated explicitly (for example, "30–40% gross margin, typical for this category").
3. **Tech posts link to primary sources.** Engineering write-ups link to source code, official documentation, or the original paper. If we make a claim about a model's behavior, we show the prompt, the response, and the conditions under which we observed it.
4. **No hidden commercial intent.** Affiliate links, sponsored placements, and private-domain funnels do not appear on this blog. The only outbound commercial link is to [mailminer.work](https://mailminer.work) in the site header, footer, and this page — clearly labeled.
5. **Corrections are visible.** If we get something wrong, we update the post and leave a dated note at the top. We do not silently rewrite history.
